    ...
    if (isset($_POST['action'])) {
        if ($_POST['mode'] == 'add') {
            ...
            if ($num == 0) {
                executeQuery(
                    'ssssissssi',
                    [$_POST['agency'], $_POST['gacc'], $_POST['state'], $_POST['name'], 0, $_POST['timezone'], $_POST['location'], $_POST['website'], $_POST['phone'], $_POST['active']],
            ...
            executeQuery(
                'ssssssssii',
                [$_POST['agency'], $_POST['gacc'], $_POST['state'], $_POST['name'], $_POST['timezone'], $_POST['location'], $_POST['website'], $_POST['phone'], $_POST['active'], $_POST['id']],
