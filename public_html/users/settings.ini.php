...
// get info from the users profile
$profile = executeQuery(
    'i',
    [$_SESSION['uid']],
    "SELECT first_name, last_name, email, password, phone, location, provider, created FROM users WHERE uid = ?"
);
...
if (isset($method)) { ?>
    ...
    <div class="btn-group centered">
        <input type="submit" class="btn btn-green" value="<?= $btnText ?>">
