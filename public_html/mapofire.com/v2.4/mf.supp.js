...
class Weather {
    ...
    fireWxFcst() {
        ...
        if (config.workers.fwf == null) {
            config.workers.fwf = new Worker(config.specificURL + 'v' + version + '/fwf.js');
        ...
        try {
            ...
            if (prop.temperature) {
                ...
                let a = Math.round((Math.max.apply(null, temp) * 1.8) + 32),
                    ...
                    btn = '<div class="btn-group centered" style="margin:1em 0 0 0">';
                ...
                if (holder != null) {
                    holder.innerHTML = '<h2>Incident Weather Concerns</h2><div class="message error">The 24-hour fire forecast is unavailable at this time.</div>';
                }
            }
        } catch (error) {
            console.error('There is an error getting incident weather concerns', error);
