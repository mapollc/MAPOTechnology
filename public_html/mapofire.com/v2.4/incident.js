...
self.onmessage = (e) => {
    ...
    <div class="incident">
        ...
        <div class="stats">
            <div class="stat">
                <p>Status</p>
                <div class="v"><span class="status ${st1}" title="${ucfirst(st1)}">${st1}</span></div>
            </div>
            <div class="stat">
                <p>Size</p>
            ...
            <div class="stat">
                <p>Containment</p>
                <div class="v" style="line-height:0" title="${(contain == 'N/A' ? `Unknown if this incident is contained` : `This incident is ${contain} contained`)}">
                    <div class="cont">
                        ${(contain != 'N/A' ? `<div class="line"><span${contain == '100%' ? ' style="color:#fff"' : ''}>${contain}</span><div style="width:${contain}${contain == '100%' ? ';opacity:1' : ''};border-radius:${contain.replace('%', '') >= 96 ? '4px' : '4px 0 0 4px'}"></div></div>` : 'N/A')}
                    </div>
                </div>
            </div>
            <div class="stat">
        ...
        <div class="row no-gap75">
            ...
            <div class="col w50">
                <div class="data-list">
                    ...
                    <div class="data">
                        <div class="icon"><i class="fad fa-cloud-question"></i></div>
