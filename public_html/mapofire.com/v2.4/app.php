    ...
    <div class="main">
        <nav>
            <div class="nav-wrapper">
                ...
                <ul>
                    ...
                    ?>
                    <li class="ttip" data-action="basemap" data-tooltip="Basemaps"><i class="fas fa-grid"></i><span>Maps</span></li>
                    <li class="ttip" data-action="layers" data-tooltip="Map Layers"><i class="fas fa-sharp fa-layer-group"></i><span>Layers</span></li>
                    ...
                    <li class="ttip" id="refresh" data-action="refresh" data-tooltip="Refresh the map"><i class="fas fa-sync"></i><span>Refresh</span></li>
                    <li class="ttip" id="report" data-action="report" data-active="0" data-tooltip="Report a new fire"><i class="fas fa-location-plus"></i><span>Report</span></li>
                    <li class="ttip" id="save" data-action="save" data-tooltip="Sync map settings"><i class="fas fa-cloud-arrow-up"></i><span>Sync</span></li>
        ...
        <div class="wrapper">
            ...
            <div class="filter-controls">
                ...
                <div class="tool control" data-action="measure"><i class="fad fa-ruler-horizontal"></i></div>
            </div>
        </div>
