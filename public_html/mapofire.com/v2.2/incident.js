...
function social() {
    return `<div class="social">
        ...
        <i class="fal fa-share-nodes" title="Share: text, email, or copy link" id="sharer"></i>
    </div>`;
}
...
let domain, agencies, stateLabels, tracked, sizeUnit, reported, updated,
    ...
    fstat, st1, st, contain, notes, fuels, resources, incstatus = 'Active', inciweb, website = '';
...
<div class="incident">
    ...
    <div class="stats">
        ...
        <div class="stat">
            <a href="#" class="btn btn-${isTracked ? 'gray' : 'yellow'} btn-sm" onclick="return false" style="margin:0" id="trackFire" data-mode="${isTracked ? 'unfollow' : 'follow'}" data-id="${wfid}" title="${isTracked ? 'You\'re following this incident' : 'Start following this incident'}"><i class="far fa-${isTracked ? 'check' : 'plus'}"></i>Follow${isTracked ? 'ing' : ''} this incident</a>
        </div>
    </div>
