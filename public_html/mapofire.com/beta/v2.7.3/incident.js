...
const social = (fireName) => {
    ...
    return `<div class="social">
            <i class="fab fa-facebook" title="Post on Facebook about #${socialName}" onclick="socialShare('fb')"></i>
            <i class="fab fa-x-twitter" title="Share #${socialName} on X" onclick="socialShare('x')"></i>
            <i class="fab fa-tiktok" title="Find #${socialName} on TikTok" onclick="socialShare('tt')"></i>
