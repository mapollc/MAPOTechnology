...
<head>
    ...
    <link rel="manifest" href="<?= "//$_SERVER[HTTP_HOST]$_SERVER[HTTP_ORIGIN]" ?>/dist/<?= $version ?>/manifest.webmanifest">
    <link rel="stylesheet" href="<?= $baseURL ?>dist/<?= $version ?>/css/main.css">
...
<body>
    ...
    <script type="module" src="<?= "{$baseURL}dist/$version/js/app.js" ?>"></script>
