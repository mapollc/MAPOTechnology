...
<? if ($orgUser['uid']) {
    echo "<input type=\"hidden\" name=\"uid\" value=\"$orgUser[uid]\">";
} ?>

<p class="message subscribe"><?= $orgName ?> invited you to use MAPO's services. Do you want to accept their invite, <b><?= $orgUser['email'] ?></b>?</p>
...
<? if (!$existingUser) { ?>
    ...
    <input type="email" value="<?= $_GET['email'] ?>" readonly placeholder="Email Address">
...
<input type="submit" class="btn btn-lg btn-blue" data-o="Accept Invitation" value="Accept Invitation">