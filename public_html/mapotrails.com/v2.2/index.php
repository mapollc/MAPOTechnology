...
<head>
    ...
    <link rel="stylesheet" href="<?=$domain?>v<?=$version?>/mt.app.css?<?=time()?>">
    <link rel="stylesheet" href="<?=$domain?>v<?=$version?>/mt.supp.css?<?=time()?>">
    <link rel="preload" href="//fonts.googleapis.com/css2?family=Dosis:wght@400;600;800&family=Roboto:wght@200;300;400;600&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    ...
    <noscript>
        <link rel="stylesheet" href="//fonts.googleapis.com/css2?family=Dosis:wght@400;600;800&family=Roboto:wght@200;300;400;600&display=swap">
...
<body>
    ...
    <nav>
        <div class="nav-wrapper">
            ...
            <ul>
                ...
                <li id="import" class="ttip" data-tooltip='{"text":"Upload a file","dir":"left"}'><i class="far fa-file-import"></i><span>Upload</span></li>
    ...
    <script async defer src="https://www.googletagmanager.com/gtag/js?id=G-4KN1GPWFWM"></script>
    <script>const version='<?=$version?>',buildDate='<?=$buildDate?>';window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-4KN1GPWFWM');</script>   
    <script src="<?=$domain?>v<?=$version?>/mt.init.js"></script>
    <script src="<?=$domain?>v<?=$version?>/mt.app.js"></script>
    <!--<script src="<?=$domain?>src/js/mt.init-<?=$version?>.js"></script>-->
