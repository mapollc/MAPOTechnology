...
/*function evacChelanCoWA() {
    ...
    for ($i = 0; $i < count($json); $i++) {
        ...
        $evac[] = ['id' => $e->OBJECTID, 'type' => 'Feature', 'geometry' => $json[$i]->geometry, 'properties' => $prop];
    }
