...
if ($host == 'mapotrails.com' || $host == 'lagranderide.com') {
    ...
    $site = 'mapotrails';
    $logoA = 'mapotrails_logo.png';
    $logoB = 'mapotrails_logo_transparent.png';
} else if ($host == 'mapofire.com' || $host == 'wildfiremap.org' || $host == 'fireweatheravalanche.org') {
    $siteProduct = 'Map of Fire';
    $site = 'mapofire';
    $logoA = 'mapofire_logo.png';
    $logoB = 'mapofire_logo_transparent.png';
} else {
    $siteProduct = 'MAPO LLC';
    $site = 'mapo';
    $logoA = 'mapo_logo_small.png';
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="any" href="<?= $domain ?>assets/images/favicon.png">
    <? if ($site == 'mapo') {
        echo "<link rel=\"manifest\" href=\"//$_SERVER[HTTP_HOST]$_SERVER[HTTP_ORIGIN]/mapo.webmanifest\">";
    } ?>
    ...
    if ($_SERVER['PHP_SELF'] == '/legal.php') { ?>
        <style>.legal ol li{ margin: 10px 0 5px 25px; font-size: 18px; font-weight: 600; letter-spacing: 1px; padding: 0} .legal ol li span{ padding-left: 10px; font-size: 20px;} .legal ul{ margin-left: 90px !important;} .legal p{ margin-left: 55px !important;} .legal ul li{ font-size: 18px; line-height: 1.5; padding: 5px 0 5px 10px} .legal p:nth-child(-n + 6){ margin-left: 0 !important} .legal p.ind{ margin-left: 110px !important}</style>
    <? } ?>
</head>
